...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <img src="img/cabecera.png" alt="..." " height="60"  >
        ...
        <asp:GridView ID="gv_Tabla_Prestamo_Aceptado_Socio" runat="server" EmptyDataText="Usted no ha patrocinado aun a ninguna persona" OnRowCommand="gv_Tabla_Prestamo_Aceptado_Socio_RowCommand" OnPageIndexChanging="gv_Tabla_Prestamo_Aceptado_Socio_PageIndexChanging" OnRowDataBound="gv_Tabla_Prestamo_Aceptado_Socio_RowDataBound" CssClass="table table-bordered table-hover" Width="65%" AutoGenerateColumns="False" GridLines="None">
