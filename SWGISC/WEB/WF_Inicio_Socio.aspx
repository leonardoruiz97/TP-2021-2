    ...
    <div class="main__cards">
      <div class="card">
        <div class="card__header">
          <div class="card__header-title text-light"><strong>Eventos del Mes de Julio</strong>
        ...
        <div class="card__main">
          <div class="card__row">
            ...
            <div class="card__detail">
              <div class="card__source text-bold">Homenaje por el Dia del Maestro</div>
              <div class="card__description">Pequeño homenaje a todos los maestros asociados a nuestra cooperativa</div>
              <div class="card__note">8:30 p.m. Plataforma Zoom</div>
            </div>
          </div>
          <div class="card__row">
            <div class="card__icon"><i class="fas fa-book"></i></div>
