...
<script type="text/javascript">
    $(function () {
        $("#<% = gv_Tabla_Lista_Solicitud.ClientID %> table").tablesorter();
      $("#<% = txtfiltro.ClientID %>").quicksearch("#<% = gv_Tabla_Lista_Solicitud.ClientID %> table tbody tr");
  })
</script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="field" id="searchform">
        ...
        <asp:TextBox ID="txtfiltro" runat="server" class="form-control" OnTextChanged="txtfiltro_TextChanged" Width="15%"></asp:TextBox>
