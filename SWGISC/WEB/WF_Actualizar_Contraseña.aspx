<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WF_Actualizar_Contraseña.aspx.cs" Inherits="WF_Actualizar_Contraseña" %>
...
<div class='box'>
  <div class='box-form'>
    ...
    <div class='box-login-title'>
      <div class='i i-login'></div><h2>NuevaContraseña</h2>
    </div>
    <div class='box-login'>
      <div class='fieldset-body' id='login_form'>
        ...
        <asp:Label ID="txtfkpatrocinador" runat="server" Text="" Visible="false"></asp:Label>
          ...
          <label for='user'>Ingrese Nueva contraseña</label>
           <asp:TextBox ID="txtContraseña" TextMode="Password" minlength="8" MaxLength="8" runat="server" placeholder="Contraseña"></asp:TextBox>
          <span id='valida' class='i i-warning'></span>
        </p>
      	  <p class='field'>
          <label for='pass'>Vuelve a escribir tu contraseña </label>
           <asp:TextBox TextMode="Password" ID="txtContraseña2" minlength="8" MaxLength="8" runat="server" placeholder="Contraseña"></asp:TextBox>
          <span id='valida2' class='i i-close'></span>
        </p>

          
           <asp:Button class="btnIniciar" runat="server" Text="ACEPTAR" OnClick="Unnamed_Click"></asp:Button>
